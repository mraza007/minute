      ...
      <div style={{ maxWidth: 720, padding: '30px 34px 48px' }}>
        ...
        */}
        ...
        <Section title="Auto-stop">
          ...
          />
          <div style={noteTextStyle}>
            If nothing has been audible for 3 minutes — no mic, no system audio — Minute shows a warning with a
            2-minute countdown, then stops and transcribes on its own. When the meeting ends with a goodbye, the
            warning appears after 1 minute instead. Any sound, or one click, keeps it going. Saves a forgotten
            recording from running overnight.
          </div>
        </Section>
