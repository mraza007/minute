...
![version](https://img.shields.io/badge/version-1.0.1-c8412a)

![Minute — meeting overview with summary, decisions, action items, markers, and local ask](screenshots/hero.png)

**[⬇ Download Minute 1.0.1 for Apple Silicon](https://github.com/mraza007/minute/releases/download/v1.0.1/Minute-1.0.1-arm64.zip)**

Using an Intel Mac? [Download the Intel build](https://github.com/mraza007/minute/releases/download/v1.0.1/Minute-1.0.1-x86_64.zip).
