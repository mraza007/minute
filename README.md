...
![version](https://img.shields.io/badge/version-1.12.0-c8412a)
...
**[⬇ Download Minute 1.12.0 for Apple Silicon](https://github.com/mraza007/minute/releases/download/v1.12.0/Minute-1.12.0-arm64.zip)**

Using an Intel Mac? [Download the Intel build](https://github.com/mraza007/minute/releases/download/v1.12.0/Minute-1.12.0-x86_64.zip).
